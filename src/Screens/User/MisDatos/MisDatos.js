...
const MisDatos = ({ navigation }) => {
  ...
  const [emptybene,setEmptybene]=useState("")
  ...
  const getMyDataBene = () => {
    ...
    fetch(URIDATOBE, {
      ...
      .catch((error) => {
        // Manejar el error de la solicitud
        console.error(error);
        setEmptybene("No hay beneficiarios")
    ...
    >
      <ScrollView>
        <View style={styles.container}>
          <Pressable
            onPress={getdatas}
            onLongPress={outdatas}
            style={styles.botininvestpro}
          >
          ...
          {banderaDatos ? (
            <View style={styles.cardmydata}>
              <Text style={styles.txtmisdatosContent}>CALLES: {calle} </Text>
              <Text style={styles.txtmisdatosContent}>COLONIA: {colonia} </Text>
              <Text style={styles.txtmisdatosContent}>
                DELEGACI&Oacute;N: {delegacion}{" "}
              </Text>
          ...
          (
            <View style={styles.cardmydata}>
              ...
              (
                beneficiarios.map((beneficiario) => (
                  <View key={beneficiario.beneficiarioId}>
                    ...
                    <Text style={styles.txtmisdatosContent}>
                      Apellido Paterno: {beneficiario.apPat}
                    </Text>
                    <Text style={styles.txtmisdatosContent}>
                      Apellido Materno: {beneficiario.apMat}
                    </Text>
                    <Text style={styles.txtmisdatosContent}>
                      Procentaje: {beneficiario.porcentaje}
                    </Text>
                  </View>
                )
                )
              ...
              (
                <View>
                   <Text style={styles.txtalertsempty}>No hay beneficiarios registrados </Text>
                </View>
